...
Lastly, one can request that the function returns the optimal transformation estimates using the argument **gopt** as well as the PTE of the primary outcome information only, denoted as **R.opt.ind**, (similar to **R.t.estimate** above) using the argument **ind**, as shown below. 
